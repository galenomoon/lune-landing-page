      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between relative">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            exit={{ opacity: 0, x: 20 }}
            transition={{ duration: 0.3, ease: "easeInOut" }}
            className="fixed bottom-6 right-4 md:right-8 self-end"
          >
            <Button
              onClick={() => openWhatsApp()}
              className=" md:static bottom-6 bg-[#50B820] text-white text-[16px] gap-2 rounded-full w-[60px] h-[60px] hover:bg-[#45a01c] transition-colors"
            >
